...

{
  ...
  s3_secret: secret.new('nextcloud-s3', {
    OBJECTSTORE_S3_HOST: std.base64('minio-hl'),
    OBJECTSTORE_S3_BUCKET: std.base64('nextcloud'),
    OBJECTSTORE_S3_KEY: std.base64('pY0LExTf12QAjGIWminQ'),
    OBJECTSTORE_S3_SECRET: std.base64('SeT4VMh9W10bEzrYLNazOE7tZ6wcolw3D8viQGst'),
